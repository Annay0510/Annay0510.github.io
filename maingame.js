...
function fstQuest(){
    ...
    if(numOne==="A"){
        alert ("You're answer is true! For the next round, just click on the 2!")}
            ...
            else alert ("No treaure for you!")
    }

function sndQuest(){
        var numTwo= prompt("Quest 1 - Solve the riddle: Neat and in order...you get the gist. This tag is used to number your list. Is it A <ol> or B <numli>?")
        if(numTwo==="A"){
            alert ("You're answer is true! For the next round, just click on the 2!")}
...
function trdQuest(){
        var numThree= prompt("Quest 1 - Solve the riddle: Neat and in order...you get the gist. This tag is used to number your list. Is it A <ol> or B <numli>?")
        if(numThree==="A"){
            alert ("You're answer is true! For the next round, just click on the 2!")}
...
function frthQuest(){
     var numFour= prompt("Quest 1 - Solve the riddle: Neat and in order...you get the gist. This tag is used to number your list. Is it A <ol> or B <numli>?")
        if(numFour==="A"){
            alert ("You're answer is true! For the next round, just click on the 2!")}
